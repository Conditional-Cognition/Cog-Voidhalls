...
import com.cogworks.voidhalls.worldgen.*;
...
public class ModWorldgen {
    ...
    public static final DeferredHolder<MapCodec<? extends ChunkGenerator>, MapCodec<Layer1ChunkGenerator>> LAYER_1_GENERATOR =
            CHUNK_GENERATORS.register("layer_1", () -> Layer1ChunkGenerator.CODEC);
